...
for bot in PLAYERS:
    white_wins = sum(1 if winners[bot][other] == Color.WHITE else 0 for other in winners[bot])
    black_wins = sum(1 if winners[other][bot] == Color.BLACK else 0 for other in winners[bot])
